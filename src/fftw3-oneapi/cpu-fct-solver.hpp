...
template <typename T>
class fctSolver {
  using fftw_plan_T = decltype(fftwTraits<T>::plan);
  int         dims[DIM];
  T          *rhsBuffer;    // Should be generated by fftw_malloc().
  T          *pBuffer;      // Should be generated by fftw_malloc().
  ...
  void fctForward(T *v);
  // Only for validations, the pointer v should be generated by fftw_malloc().
